    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('events.update', $event) }}"
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" id="start_date" name="start_date"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            value="{{ old('start_date', $event->start_date->format('Y-m-d H:i:s')) }}">
                        @error('start_date')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="datetime-local" id="end_date" name="end_date"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            value="{{ old('end_date', $event->end_date->format('Y-m-d H:i:s')) }}">
                        @error('end_date')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    @foreach ($tickets as $index => $ticketType)
                        <div class="ticket" data-index="{{ $index }}">
                            <h3 class="mt-4 font-semibold text-gray-900 dark:text-white">{{$ticketType?->ticket_type?->name}}</h3>
                            <div class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                ...
                                <div class="flex items-center pl-3">
                                    <input type="hidden" name="ticket_types[{{ $index }}][ticket_type_id]" value="{{$ticketType?->ticket_type_id}}">
                                ...
                                <div class="flex items-center pl-3 gap-2">
                                    ...
                                    <input
                                        ...
                                        x-data="{ price: {{$ticketType->price}}, isValid: true }"
                                        x-model="price"
                                        @input="
                                ...
                                quantity: 1,
                                    ...
                                    <input type="number" name="ticket_types[{{ $index }}][quantity]" x-model.number="{{$ticketType->quantity}}" @input="if (quantity < 1) quantity = 1;" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                 ...
                                 <div class="flex items-center pl-3">
                                    ...
                                    <input type="datetime-local"  value="{{ old('ticket_types[$index][sale_starts_at]', $ticketType?->sale_starts_at?->format('Y-m-d H:i:s')) }}" id="ticket_types[{{ $index }}][sale_starts_at]" name="ticket_types[{{ $index }}][sale_starts_at]"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div class="flex items-center pl-3">
                                    ...
                                    <input type="datetime-local" value="{{ old('ticket_types[$index][sale_ends_at]', $ticketType?->sale_ends_at?->format('Y-m-d H:i:s')) }}" id="ticket_types[{{ $index }}][sale_ends_at]" name="ticket_types[{{ $index }}][sale_ends_at]"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Laravel event">
